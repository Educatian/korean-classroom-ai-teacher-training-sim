        ...
        private static string RoleTextFor(TrainingSceneId sceneId)
        {
            return sceneId switch
            {
                ...
                TrainingSceneId.Schoolyard =>
                    "당신은 담임 교사입니다. 쉬는 시간 운동장에서 놀이 배제, 규칙 분쟁, 몸싸움 직전 상황까지 빠르게 번지는 위기에 대응합니다.\n" +
                    "야외의 비구조화된 시간은 갈등이 가장 잦은 순간입니다. 안전 확보와 존엄 보호의 균형을 연습하세요.",
                TrainingSceneId.Gymnasium =>
                    "당신은 담임 교사입니다. 강당 학예회 리허설에서 무대 불안, 소음 과부하, 단체 활동 이탈에 대응합니다.\n" +
                    "울리는 소리와 많은 시선이 자극을 키우는 공간입니다. 감각 부담을 읽고 참여의 문턱을 낮추는 대응을 연습하세요.",
                _ =>
